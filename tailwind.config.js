...
export default {
  ...
  theme: {
    extend: {
      ...
      colors: {
        'light-background': '#7f1d1d', // color corresponding to rose-300
        'light-text': '#111827', // color corresponding to gray-900
        'light-accent': '#7379BF', // dark blue
        'light-accent-hover': '#97A0FC', // blue
        'light-secondary': '#7f1d1d', // pink
        'light-secondary-hover': '#dc2626', // dark pink
        ...
        'dark-background': '#7f1d1d', // color corresponding to rose-600
